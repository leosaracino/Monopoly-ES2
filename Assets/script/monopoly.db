INSERT INTO paises (id, ip, cost, rent, houses, description, mortgage, rentdescription) VALUES 
...
DELETE FROM paises WHERE houses=0;

SELECT rentdescription FROM paises;